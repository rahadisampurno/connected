      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Tentang <span className="bg-gradient-to-r from-red-600 to-blue-600 bg-clip-text text-transparent">Connected</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Platform "Connected" diusulkan sebagai pusat agregasi REST API internal yang krusial bagi 
        ...
        <div className="bg-gradient-to-r from-red-600 to-blue-600 rounded-2xl p-8 md:p-12 text-white mb-16">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Visi Strategis</h2>
            <p className="text-lg md:text-xl leading-relaxed mb-6">
              Pentingnya strategis "Connected" melampaui sekadar agregasi teknis; platform ini berfungsi 
