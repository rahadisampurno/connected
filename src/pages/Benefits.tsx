      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Platform "Connected" memberikan value proposition yang signifikan 
        ...
        <div className="bg-gradient-to-r from-red-600 to-blue-600 rounded-2xl p-8 md:p-12 text-white mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg opacity-90">
              Hasil yang terukur dari implementasi platform "Connected"
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Investasi dalam platform "Connected" menghasilkan ROI yang signifikan 
